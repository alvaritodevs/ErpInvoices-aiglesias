...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <form action="<?php echo $helper->url("tarifas","crear"); ?>" method="post" class="col-lg-5" id="newtarifa">
            <h3>Nueva tarifa</h3>
        
            <hr/>
          
            tarifa: <input type="text" name="tarifa" class="form-control"  />
            preciohora: <input type="number" name="preciohora" class="form-control"   />
