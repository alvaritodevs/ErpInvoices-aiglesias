...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <form action="<?php echo $helper->url("roles","actualizar"); ?>" method="post" class="col-lg-5" id="editrole">
            <h3>Editar role</h3>
            <input type="hidden" name="id"  value="<?php echo $role->id;?>" />
            <hr/>
            Role: <input type="text" name="role" class="form-control" value="<?php echo $role->role;?>" />
...
$(document).ready(function() {
  ...
  $("#editrole").validate({
    ...
    messages: {
        role: {
        required: "Porfavor introduzca un rol."
      }
    },
