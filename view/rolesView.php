...
<body class="fix-header">
    ...
    <div id="wrapper">
        ...
        <section class="col-lg-12 usuario">
              ...
              <a href="<?php echo $helper->url("Roles","exportar");?>" class="btn btn-success">Exportar</a> 
                <hr/>
                                ...
                                <table class="table color-table primary-table" id="tabla">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href="<?php echo $helper->url("roles","imprimir"); ?>&id=<?php echo $role->id; ?>" class="btn btn-info">Imprimir</a>
                                            </td>
                                        </tr>
                                         <?php } ?>
